...
<tr>
    ...
    <td>{{ $quote->phone }}</td>
    <td>
        <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#viewQuoteModal{{ $quote->id }}">
            View
        </button>
    </td>
</tr>
...
<!-- Quote Modal -->
<div class="modal fade" id="viewQuoteModal{{ $quote->id }}" tabindex="-1" aria-labelledby="viewQuoteLabel{{ $quote->id }}" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p><strong>Address:</strong> {{ $quote->address }}, {{ $quote->city }}, {{ $quote->state }}, {{ $quote->country }} - {{ $quote->zip }}</p>
                <p><strong>Product ID:</strong> {{ $quote->product_id }}</p>
                <p><strong>Color ID:</strong> {{ $quote->color_id }}</p>
                    ...
                    @if ($quote->customization)
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-md-12">
                                                                                                ...
                                                                                                <div class="collapse"
                                                                                                    id="collapseCustomization{{ $quote->id }}">
                                                                                                    <div class="row mb-3">
