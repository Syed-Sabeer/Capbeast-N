...
@section('content')
    ...
    <div class="d-flex justify-content-end mb-4">
      <a href="{{ route($prefix.'.brand.add') }}" class="btn btn-primary">Add Design</a>
    </div>
    <!-- Designs List Table -->
    <div class="card">
                    ...
                    @foreach ($customizerDesigns as $key => $design)
                        <tr>
                            ...
                            <td>
                              <div class="w-25 d-flex justify-content-end">
                                <label class="switch switch-primary switch-sm me-4 pe-2">
                                    <input type="checkbox" class="switch-input" data-id="{{ $design->id }}" {{ $design->status == '1' ? 'checked' : '' }}>
                            ...
                            <td>
                              ...
                              <a href="" class="btn btn-sm btn-danger delete_confirm">Delete</a>
