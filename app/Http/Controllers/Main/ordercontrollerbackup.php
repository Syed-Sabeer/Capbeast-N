...
class OrderController extends Controller
{
    ...
    public function getShippingRate(Request $request)
    {
        ...
        try {
            $payload = [
                "carrier_type" => "stallion", // or "canada_post" or "usps" depending on service
                "to_address" => [
                ...
                "parcels" => [
                    [
                        "weight" => $validated['weight'], // in pounds
                        "length" => $validated['length'], // in inches
            ...
            if ($response->successful()) {
                ...
                // Pick the cheapest rate (or customize logic)
